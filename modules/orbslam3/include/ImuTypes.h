...
class Calib
{
  ...
  void serialize(Archive &ar, const unsigned int version)
  {
    ...
    ar &boost::serialization::make_array(
      Cov.diagonal().data(), Cov.diagonal().size());
    ar &boost::serialization::make_array(
      CovWalk.diagonal().data(), CovWalk.diagonal().size());
...
class Preintegrated
{
  ...
  void serialize(Archive &ar, const unsigned int version)
  {
    ...
    ar &boost::serialization::make_array(
      Nga.diagonal().data(), Nga.diagonal().size());
    ar &boost::serialization::make_array(
      NgaWalk.diagonal().data(), NgaWalk.diagonal().size());
    ar &b;
